...
if __name__ == "__main__":
    # dataset
    dataset = PersonsImages('/home/mudro/Documents/Projects/siamese/labels_data.json')
    ...
    with start_run(description=f"Run with epoch ${EPOCH} and Custom Triplet loss, small dataset"):
        ...
        trainer = TrainerManager(
            model,
            '/home/mudro/Documents/Projects/siamese/saved_model/siamese_dot_attn_bce_v3.pt',
